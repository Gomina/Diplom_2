...
from data import TU
from helper import UserMethods, RequestsTools
...
class TestUserCreation:
    ...
    def test_creation_unique_user(self, delete_created_user):
        ...
        response = RequestsTools.requests_creation_user(payload)
    ...
    def test_re_creating_user(self, delete_created_user):
        ...
        first_response = RequestsTools.requests_creation_user(TU.User_1)
        token = first_response.json().get("accessToken")
        delete_created_user(token)
        # попытаться создать пользователя с теми же данными
        second_response = RequestsTools.requests_creation_user(TU.User_1)
    ...
    def test_creation_user_without_one_data(self, delete_created_user, user_data):
        ...
        response = RequestsTools.requests_creation_user(user_data)
...
class TestUserLogin:
    ...
    def test_login_user_unfaithful_password(self, user_data_login, create_and_delete_user):
        # авторизоваться с неверными данными
        login_response = RequestsTools.requests_login_user_incorrect_data(
            user_data_login["email"],
...
class TestUserСhange:
    ...
    def test_change_email(self, create_and_delete_user):
        ...
        change_response = RequestsTools.requests_update_user(new_data, token)
        # проверка статуса ответа
    ...
    def test_inability_change_all_data_without_login(self, create_and_delete_user):
        ...
        change_response = RequestsTools.requests_update_user_without_token(new_data)
        # проверка статус кода
